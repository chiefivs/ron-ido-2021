...
namespace Ron.Ido.Tests.BM
{
    ...
    public class ApplyStatusServiceTests
    {
        ...
        /// <summary>
        /// Проверить наличие статусов и возможность перехода между ними
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Проверить несколько простых переходов между статусами и откатить последнее изменений
        /// </summary>
        [TestMethod]
