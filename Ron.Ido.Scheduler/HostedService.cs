using Cargo.App.BM.Integration.OneC;
using Cargo.App.BM.Integration.Oscar;
using Cargo.App.BM.Integration.Util;
using Cargo.App.Common.Extensions;
using Cargo.App.EM.Entities;
using Cargo.App.Scheduler;
using Cargo.App.Scheduler.OneCClient;
using Cargo.InteractionBus.Common;
using Cargo.Logging.Common;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Logging;
using Ron.Ido.BM.Models.Scheduler;
using System;
...
namespace Ron.Ido.Scheduler
{
	...
	public sealed class HostedService : IHostedService, IDisposable
	{
		...
		public HostedService( IServiceProvider provider )
		{
			...
			var broker = _provider.GetService<IBroker>();
			broker.RegisterService<OneCImportService>();
			broker.RegisterService<OneCExportService>();
			broker.RegisterService<ModuleSideService>();
			//#if DEBUG
			broker.RegisterService<AmqTestService>();
			//#endif
