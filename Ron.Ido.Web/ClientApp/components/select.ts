...
export function init(){
    ko.components.register('cmp-select', {
        ...
        template: `
            <select class="form-control" data-bind="value: value, options: options, optionsText: optionsText, optionsValue: optionsValue, optionsCaption: optionsCaption, optionsAfterRender: afterRender, hasFocus:hasFocus, css:css, event:{keydown:keyDown}, disable:disable, attr:{readonly:readonly}"></select>`
    });
}
